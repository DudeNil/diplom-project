...
<form action="{{ route('register') }}" method="POST" class="online-signup">
    @csrf
    ...
    <select name="service" class="form-select form-select-lg mb-3 online-signup__input" aria-label="Large select example">
    ...
    <select name="master_barber" class="form-select form-select-lg mb-3 online-signup__input" aria-label="Large select example">
    ...
    <div class="radio-block">
        ...
        <label for="radio-1">10:00 <input value="10:00" class="btn-radio" type="radio" name="radio-1" id="radio-1"></label>
        <label for="radio-2">12:00 <input value="12:00" class="btn-radio" type="radio" name="radio-1" id="radio-2"></label>
        <label for="radio-3">14:00 <input value="14:00" class="btn-radio" type="radio" name="radio-1" id="radio-3"></label>
        <label for="radio-4">16:00 <input value="16:00" class="btn-radio" type="radio" name="radio-1" id="radio-4"></label>
        <label for="radio-5">18:00 <input value="18:00" class="btn-radio" type="radio" name="radio-1" id="radio-5"></label>
