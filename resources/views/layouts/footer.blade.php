<hr>
<footer class="footer">
    <img class="footer__image" src="/img/logobarber.png" alt="logo-barber" width="100px">
    <div class="footer__block-text">
        <p>ООО «Барбершоп»</p>
        <p>ИНН 6685028654</p>
        <p>ОГРН 1136685004455</p>
        <p>620075, Екатеринбург, Мамина-Сибиряка 102</p>

    </div>
    <div class="footer__block-href">
        <ul class="footer__ul">
            <li><a class="footer__link" href="{{ route('main')}}">главная</a></li>
            <li><a class="footer__link" href="{{ route('about')}}">о нас</a></li>
            <li><a class="footer__link" href="{{ route('price')}}">цена вопроса</a></li>
            <li><a class="footer__link" href="{{ route('barbers')}}">наши барберы</a></li>
            <li><a class="footer__link" href="{{ route('blog')}}">блог</a></li>
